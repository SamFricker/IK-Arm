...
* google slide documenting process: [https://docs.google.com/presentation/d/11Yj7fBU4LIVXhnzH5_TuppZ-_PNuySzZH2yjffFqX7w/edit?usp=sharing](url)
...
```bash
g++ code/InverseKinematics/InverseKinematics.INO
```
